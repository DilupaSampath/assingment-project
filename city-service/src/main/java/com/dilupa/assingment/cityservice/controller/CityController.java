...
public class CityController {
     ...
     */
    @GetMapping({"/cities"})
    public ResponseEntity<Page<City>> getAllWithPagination(@RequestParam("offset") int offset, @RequestParam("pageSize") int pageSize , @RequestParam(required = false, name = "filter") String filter) throws Exception {
        Page<City> cityListResult = cityService.getAllWithPagination(offset, pageSize, filter);
